...
RUN git clone https://github.com/thu-ml/SageAttention.git && \
    ...
    wget https://github.com/mjun0812/flash-attention-prebuild-wheels/releases/download/v0.7.16/flash_attn-2.8.3+cu130torch2.9-cp312-cp312-linux_x86_64.whl && \
	pip install --no-cache-dir flash_attn-2.8.3+cu130torch2.9-cp312-cp312-linux_x86_64.whl && \
...
RUN echo 'echo -e "\nFor detailed documentation and guides, please visit:\n\033[1;34mhttps://cnb.cool/BigBomb\033[0m and \033[1;34mhttps://cnb.cool/itgay\033[0m\n\n"' >> /root/.bashrc
