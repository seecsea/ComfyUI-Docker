...
RUN git clone https://github.com/thu-ml/SageAttention.git && \
    ...
    wget https://github.com/mjun0812/flash-attention-prebuild-wheels/releases/download/v0.7.16/flash_attn-2.8.3+cu128torch2.8-cp313-cp313-linux_x86_64.whl && \
	pip install --no-cache-dir flash_attn-2.8.3+cu128torch2.8-cp313-cp313-linux_x86_64.whl && \
	rm -f flash_attn-2.8.3+cu128torch2.8-cp313-cp313-linux_x86_64.whl
